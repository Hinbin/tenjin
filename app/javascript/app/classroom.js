$(document).on("turbolinks:load", () => {
  if (page.controller() === "classrooms") {
    ...
    $("div.passwordCheck").html(
      '<div class="form-check-inline"><input class="form-check-inline" id="resetPasswordCheck" type="checkbox"></input><label class="form-check-label" for="resetPasswordCheck"> Reset Passwords?</label></div>',
    );
