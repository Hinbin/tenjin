...
module GlyphHelper
  ...
  GLYPHS = {
    ...
    ball: '<circle cx="12" cy="12" r="8.6"/><path d="M12 7.1l3.2 2.4-1.2 3.8h-4l-1.2-3.8z"/><path d="M12 7.1V3.6M15.2 9.5l3-1.1M14 13.3l2.2 2.9M10 13.3l-2.2 2.9M8.8 9.5l-3-1.1"/>'
  }.freeze
